...
class SubsidiesAnalysis:
    def get_subsidies_analysis_insights(self) -> str:
        ...
        return self._generate_subsidies_content()

    def _generate_subsidies_content(self) -> str:
        """Generate the complete subsidies analysis content with visuals and metrics."""
        return '''
            ...
            <div class="analytics-card">
                ...
                <div class="section">
                    ...
                    <div class="visual-content">
                        <h4>Distribution des Subventions par Code APE</h4>
                        <iframe src="html_viz/subsidies_heatmap_Code APE_Source Principale.html" 
                    ...
                    <div class="visual-content">
                        <h4>Analyse des Délais de Financement</h4>
                        <iframe src="html_viz/subsidies_heatmap_Délai_Alternative 1.html" 
                                style="width:100%; height:800px; border:none;"></iframe>
                        <iframe src="html_viz/subsidies_heatmap_Délai_Alternative 2.html" 
                                style="width:100%; height:800px; border:none;"></iframe>
                    </div>
                    ...
                    <div class="visual-content">
                        ...
                        <iframe src="html_viz/funding_treemap.html" 
                                style="width:100%; height:800px; border:none;"></iframe>
                    </div>
    ...
    def update_powerbi_file(self):
        ...
        try:
            ...
            if 'id="subsidies_analysis.html"' not in current_content:
                content_to_add = self.get_subsidies_analysis_insights()
                
                with open('PowerBI.html', 'a', encoding='utf-8') as f:
                    f.write(content_to_add)
                print("Analyse des subventions ajoutée avec succès!")
            else:
                print("Le contenu existe déjà dans le fichier.")
